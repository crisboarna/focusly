...
export default function Landing() {
  const { visible, hidden, focus } = usePageVisibility();
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
            <div
              className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1 flex justify-center items-center"
              data-aos="fade-up">
              <div className="max-w-full mx-auto md:max-w-none h-auto">
                <div className="flex justify-center items-center">
                  Page is {visible && !hidden && focus ? 'visible' : 'hidden'} for
                </div>
                <Counter reset={visible && !hidden && focus}/>
                <Logger hidden={hidden} visible={visible} focus={focus}/>
              </div>
            </div>
            {/* Content */}
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16">
                <div className="font-architects-daughter text-xl text-purple-600 mb-2">More focus. Less time</div>
                <h3 className="h3 mb-3">Keep tabs & windows in focus</h3>
                <p className="text-xl text-gray-400 mb-4">Focusly intercepts browser events and allows you to override for specific website domains the behaviour for a variety of events</p>
                <ul className="text-lg text-gray-400 -mb-2">
                  ...
                  <li className="flex items-center mb-2">
                    ...
                    <span>Document (webkit/moz)hidden</span>
                  </li>
                  <li className="flex items-center mb-2">
                    <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12"
                         xmlns="http://www.w3.org/2000/svg">
