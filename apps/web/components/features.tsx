        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up"
              ...
              <h4 className="h4 mb-2">Keeps focus</h4>
              <p className="text-lg text-gray-400 text-center">You can switch tabs, windows or screens and the website
                will keep behaving as if you were looking at it.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
              ...
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <path className="stroke-current text-purple-300" d="M26 28h12M26 32h12M26 36h5" strokeWidth="2"
                      strokeLinecap="square" />
              </svg>
              <h4 className="h4 mb-2">Configurable domain</h4>
              <p className="text-lg text-gray-400 text-center">You can configure at a granular level the domains and subdomains on which the plugin activates. </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
              ...
              <h4 className="h4 mb-2">Configurable events</h4>
              <p className="text-lg text-gray-400 text-center">You can select the browser events for which the behaviour
                gets overridden.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300"
              ...
              <h4 className="h4 mb-2">Audit events</h4>
              <p className="text-lg text-gray-400 text-center">By going to the options page of the extension you can
                trigger the auditing of all the APIs this extension hooks into. All you need is to open the console and
                view the events from your actions.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400"
              ...
              <h4 className="h4 mb-2">Quick reset</h4>
              <p className="text-lg text-gray-400 text-center">If you want to quickly reset the behaviour the reset button in the options page will get you out of any pickle.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500"
              ...
              <h4 className="h4 mb-2">On/Off Toggle</h4>
              <p className="text-lg text-gray-400 text-center">Easily turn on/off the extension from the toggle.</p>
            </div>
          </div>
        </div>
      </div>
